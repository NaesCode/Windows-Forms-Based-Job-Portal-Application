...
{
    public partial class changePassCompany : Form
    {
        private LogInForm? logInFormInstance;
        string? UserEmail;
        DatabaseSupport dbSupport = new DatabaseSupport();
        public changePassCompany()
        {
            InitializeComponent();
        }

        public changePassCompany(string Email)
        {
            InitializeComponent();
        ...
        private void updateButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (confPass.Equals(UserPassword.Text))
                {
                    ...
                    dbSupport.ChangeCompanyPassword(UserPassword.Text, UserEmail);
