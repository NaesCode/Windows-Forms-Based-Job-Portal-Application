...
{
    public partial class codeVerifyCompany : Form
    {
        DatabaseSupport dbSupport = new DatabaseSupport();

        private changePassCompany? changePasswordInstance;
        string? randomCode;
        bool codeSent;
        private readonly string password = "pmah mimr xjds yhzm"; //DO NOT MODIFY LOL
        public codeVerifyCompany()
        {
            InitializeComponent();
        }
        ...
        private void codeVerify_Load(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("This is for company");
        }
        ...
        private void sendVerifEmail_Click(object sender, EventArgs e)
        {
            ...
            if (dbSupport.isValidCompanyEmail(email) == false)
            {
            ...
            string? username = dbSupport.GetCompanyNameByEmail(email);
        ...
        private void verifyCode_Click(object sender, EventArgs e)
        {
            if (sentCode.Text == randomCode)
            {
                ...
                {
                    changePasswordInstance = new changePassCompany(ToEmail.Text);
